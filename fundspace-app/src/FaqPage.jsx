...
const faqData = {
  general: [
    {
      ...
      answer: 'Fundspace is a centralized grant discovery platform designed specifically for the San Francisco Bay Area. Our mission is to bridge the gap between funders and nonprofits by making it easier for organizations to find funding and for funders to discover innovative local projects.'
    },
    {
      id: 'g2',
      question: 'Who is behind Fundspace?',
      answer: 'Fundspace was founded by a team with direct experience from both sides of the funding table—former nonprofit directors and foundation program officers. We started Fundspace because we\'ve lived the challenges and knew there had to be a better way to connect purpose with progress in the Bay Area.'
    },
    {
      id: 'g3',
      question: 'What geographic area does Fundspace cover?',
  ...
  forNonprofits: [
    {
      id: 'n1',
      question: 'Is Fundspace free for nonprofits to use?',
    ...
    {
      id: 'n3',
      question: 'Can I track my grant applications on Fundspace?',
    ...
    {
      id: 'n4',
      question: 'How can our nonprofit get a profile on Fundspace?',
      ...
      <section className="text-center mb-16 relative">
        ...
        <div className="relative bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-3xl border border-white/60 shadow-2xl">
          ...
          <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Everything you need to know about Fundspace, from getting started to maximizing your impact.
