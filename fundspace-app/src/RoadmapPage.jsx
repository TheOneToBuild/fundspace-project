...
const roadmapData = [
  {
    ...
    description: 'Launch the fundspace platform with a robust, searchable database of Bay Area grants. This includes our AI aggregation engine, community-sourcing model, and powerful search and filtering tools.',
    status: 'Complete',
    icon: CheckCircle2,
    color: 'green',
  ...
  },
  {
    ...
    description: 'Launch the fundspace Community Hub, featuring forums for discussion, a directory for finding nonprofit collaborators, and resources for local workshops and events to foster a more connected social sector.',
    status: 'Planned',
    icon: Users,
    color: 'orange',
  ...
  },
  {
    ...
    description: 'Replicate our successful model and technology to bring the power of fundspace to new metropolitan areas, empowering nonprofit sectors across the country.',
    status: 'Future',
    icon: Globe,
    color: 'slate',
      ...
      <section className="mt-20">
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-8 md:p-12 rounded-3xl text-white shadow-2xl max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            fundspace is more than a platform—it's a movement to make social impact more accessible and effective. Your feedback helps shape our roadmap and ensures we're building what the community needs.
          </p>
