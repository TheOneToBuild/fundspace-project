// src/components/MyOrganizationPage.jsx - Combined best of both versions
...
// Simple organization join prompt component
            ...
            <div className="max-w-2xl mx-auto text-center">
                <div className="p-12 rounded-xl shadow-sm bg-slate-50">
                    ...
                    <p className="text-slate-600 mb-8">
                        Connect with your colleagues and team by joining your organization on Fundspace.
                        You can search for existing organizations or create a new organization profile.
                    </p>
...
export default function MyOrganizationPage() {
    ...
    // Expose refresh function globally for organization joins
    useEffect(() => {
    ...
    // Handle starting organization onboarding
    ...
    // No organization - show the full organization setup page
    ...
    // Main organization page - with proper container sizing and no borders
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="space-y-6">
                ...
                {/* Organization Header - no borders */}
                ...
                {/* Tab Navigation & Content - no borders */}
                <div className="rounded-xl overflow-hidden">
                    <OrganizationTabs 
                        activeTab={activeTab}
                ...
                <LeaveOrganizationModal 
                    ...
                    onConfirm={async () => {
                        ...
                        // Force re-check membership after leaving to show join prompt
