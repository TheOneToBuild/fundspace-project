...
// NEW Users Icon
const UsersIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm6-11a4 4 0 11-8 0 4 4 0 018 0z" /></svg>;
    ...
    return (
        <div className="p-4 bg-white rounded-xl shadow-md border border-slate-200">
            ...
            <nav className="mt-6 space-y-1">
                ...
                {/* NEW: Link to the Explore Members page */}
                <NavLink to="/members" icon={<UsersIcon />}>Explore Members</NavLink>
